...
aadd("z-decorative-0",		"concrete-brick",								"c")
aadd("z-decorative-0",		"angels-powdered-stone",						"d")
aadd("z-decorative-0",		"concrete-pulver",								"e")
...
aadd("z-decorative-3",		"concrete-red",									"a")
aadd("z-decorative-3",		"concrete-orange",								"b")
aadd("z-decorative-3",		"concrete-yellow",								"c")
aadd("z-decorative-3",		"concrete-green",								"d")
aadd("z-decorative-3",		"concrete-cyan",								"e")
aadd("z-decorative-3",		"concrete-blue",								"f")
aadd("z-decorative-3",		"concrete-purple",								"g")
aadd("z-decorative-3",		"concrete-magenta",								"h")
aadd("z-decorative-3",		"concrete-white",								"i")
aadd("z-decorative-3",		"concrete-black",								"j")

aadd("z-decorative-5",		"sign-post",									"a")
aadd("z-decorative-5",		"small-lamp",									"b")

aadd("z-decorative-6",		"small-lamp-red",								"a")
aadd("z-decorative-6",		"small-lamp-orange",							"b")
aadd("z-decorative-6",		"small-lamp-yellow",							"c")
aadd("z-decorative-6",		"small-lamp-green",								"d")
aadd("z-decorative-6",		"small-lamp-cyan",								"e")
aadd("z-decorative-6",		"small-lamp-blue",								"f")
aadd("z-decorative-6",		"small-lamp-purple",							"g")
aadd("z-decorative-6",		"small-lamp-magenta",							"h")
aadd("z-decorative-6",		"small-lamp-white",								"i")
aadd("z-decorative-6",		"small-lamp-black",								"j")

aadd("z-defense-0",			"ne-living-wall",								"e")
aadd("z-defense-0",			"forcefield-emitter",							"f")
aadd("z-defense-0",			"forcefield-tool",								"g")

aadd("z-defense-2",			"Bio_Cannon_Bio_Ammo",							"f")

aadd("z-defense-9",			"collector-grounditems",						"a")
aadd("z-defense-9",			"uplink-station",								"b")
aadd("z-defense-9",			"big_brother-surveillance-center",				"c")
...
aadd("z-gathering-2",		"homeworld-portal",								"h")

aadd("z-gathering-4",		"deep-quarry",									"b")
aadd("z-gathering-4",		"advanced-quarry",								"c")
...
aadd("z-gathering-7",		"sand-collector",								"e")

aadd("z-gathering-8",		"water-well-pump",								"b")
aadd("z-gathering-8",		"drilling-pumpjack",							"c")
aadd("z-gathering-8",		"drilling-pumpjack-mk2",						"d")
aadd("z-gathering-8",		"drilling-pumpjack-mk3",						"e")

aadd("z-gathering-12",		"sawmill",										"a")
aadd("z-gathering-12",		"distillery",									"b")
aadd("z-gathering-12",		"farm",											"c")
aadd("z-gathering-12",		"fishery",										"d")
aadd("z-gathering-12",		"seeder",										"e")
aadd("z-gathering-12",		"terraformer",									"f")

aadd("z-gathering-13",		"craft-seeder-module-01",						"a")
aadd("z-gathering-13",		"craft-seeder-module-02",						"b")
aadd("z-gathering-13",		"craft-seeder-module-03",						"c")
aadd("z-gathering-13",		"craft-seeder-module-04",						"d")
aadd("z-gathering-13",		"craft-seeder-module-05",						"e")
aadd("z-gathering-13",		"craft-terraform-module-concrete",				"f")
aadd("z-gathering-13",		"craft-terraform-module-dirt",					"g")
aadd("z-gathering-13",		"craft-terraform-module-grass",					"h")
aadd("z-gathering-13",		"craft-terraform-module-sand",					"i")
aadd("z-gathering-13",		"craft-terraform-module-stone",					"j")
...
aadd("z-intermediate-13",	"building-materials",							"b")
aadd("z-intermediate-13",	"furniture",									"c")
aadd("z-intermediate-13",	"bake-bread",									"d")
aadd("z-intermediate-13",	"luxury-meal",									"e")
aadd("z-intermediate-13",	"portable-electronics",							"f")
aadd("z-intermediate-13",	"nutrient-paste",								"g")

aadd("z-liquids-0",			"NE_alien-revitalization",						"h")
aadd("z-liquids-0",			"NE_basic-alien-nutrientant",					"i")
aadd("z-liquids-0",			"NE_enhanced-alien-nutrientant",				"j")
...
aadd("z-liquids-2",			"fertilizer",									"h")
aadd("z-liquids-2",			"bob-liquid-air",								"i")
aadd("z-liquids-2",			"bi-Clean_Air",									"j")
aadd("z-liquids-2",			"bi-Clean_Air2",								"k")

aadd("z-liquids-3",			"mashing-beer",									"a")
aadd("z-liquids-3",			"fermenting-beer",								"b")
aadd("z-liquids-3",			"fill-beer-barrel",								"c")
aadd("z-liquids-3",			"fermenting-wine",								"d")
aadd("z-liquids-3",			"maturing-wine",								"e")

aadd("z-liquids-5",			"fill-petroleum-gas-barrel",					"j")

aadd("z-liquids-6",			"empty-petroleum-gas-barrel",					"j")

aadd("z-logistic-3",		"assembly-robot",								"j")

aadd("z-logistic-10",		"belt_gate",									"a")
aadd("z-logistic-10",		"belt_throughput_reader",						"b")
aadd("z-logistic-10",		"pollution-detector",							"c")
aadd("z-logistic-10",		"wireless-mast",								"d")
...
aadd("z-other-10",			"personal-spawn-marker-recipe",					"a")
aadd("z-other-10",			"attractor-on",									"b")
aadd("z-other-10",			"attractor-off",								"c")
...
aadd("z-transport-4",		"hacked-splitter",								"i")
aadd("z-transport-4",		"hacked-fast-splitter",							"j")
aadd("z-transport-4",		"hacked-express-splitter",						"k")
...
aadd("z-weaponry-0",		"bob-laser-robot-capsule",						"k")
